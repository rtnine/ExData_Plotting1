...
plot(change_date_time, as.numeric(subSetData$Sub_metering_1), type="l", ylab="Energy Submetering", xlab="")
lines(change_date_time, as.numeric(subSetData$Sub_metering_2), type="l", col="red")
lines(change_date_time, as.numeric(subSetData$Sub_metering_3), type="l", col="blue")
